...
psqiSM  <- dat.psqi %>% dplyr::select("ID","TIB","psqi_Comp1", "psqi_Comp2", "psqi_Comp3",
									  "psqi_Comp4", "psqi_Comp5", "psqi_Comp6",
...
dat.SM  <- dat1 %>% dplyr::select("group.factor","ess_total", "bdi_total", "mcgill_total",
